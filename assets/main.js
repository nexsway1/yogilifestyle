...
(function() {
	...
	// Initialize scroll tracking.
		scrollTracking.add('.container.style4');
	
	// Initialize "On Visible" animations.
		onvisible.add('.container.style4', { style: 'fade-in-background', speed: 2000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style4 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 750, replay: false });
		onvisible.add('.image.style1', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 2, delay: 0, replay: true });
